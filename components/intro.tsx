...
import CVImage from "../public/CVImage.png";
...
export default function Intro() {
  ...
  return (
    ...
    >
      ...
      >
        <span className="font-bold">Hello, I'm Eduard.</span> I'm a
      ...
      >
        <Link
         ...
         hover:bg-gray-950 activate:scale-105
         transition"
          onClick={() => {
        ...
        <a
          className="group bg-white  text-black px-7
         py-3 flex items-center gap-2 rounded-full outline:none
         focus:scale-110 hover:scale-110
          activate:scale-105
        ...
        <a
          ...
          activate:scale-105 hover:text-blue-600
          transition cursor-pointer borderBlack dark:bg-white/10
          dark:text-white/60"
          href="https://linked.com/in/eduard-gabor-b78aab226"
          target="_blank"
        >
          <BsLinkedin />
        </a>
        ...
        transition cursor-pointer borderBlack dark:bg-white/10
        dark:text-white/60"
          href="https://github.com/Eduardq?tab=overview&from=2023-10-01&to=2023-10-05"
          target="_blank"
        >
          <FaGithubSquare />
        </a>
